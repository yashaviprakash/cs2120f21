...
What does this mean "abstracted away, and
the elimination is not been able to recover
it?"
-/
...
away. **personal note: where does it go?**
...
irrelevance." **what does this mean** Any proof is as good as any other,
